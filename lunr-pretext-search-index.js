...
},
{
  ...
  "number": "1.3.1",
  "title": "",
  "body": " Determine whether or not each of the following sets is a subspace of :     The set       The set       The set     "
},
{
  "id": "ex-ww-sub2",
  "level": "2",
...
},
{
  ...
  "number": "1.4.1",
  "title": "",
  "body": "  Let be the vector space of symmetric matrices and be the subspace    Find a nonzero element in .    Find an element in that is not in .                  "
},
{
  "id": "ex-ww-span2",
  "level": "2",
  ...
  "number": "1.4.2",
  "title": "",
  "body": "  Let be the vector space of polynomials in with degree less than 3 and be the subspace    Find a nonzero polynomial in .    Find a polynomial in that does not belong to .                  "
},
{
  "id": "ex-ww-span3",
  "level": "2",
...
},
{
  ...
  "number": "1.4.5",
  "title": "",
  "body": "  Let be a linear combination of .  Select the best statement.    There is no obvious relationship between span and span .    We only know that span span .    We only know that span span .    span span .    span span when none of is a linear combination of the others.    none of the above     span .     "
},
{
  "id": "ex-ww-span6",
  "level": "2",
  ...
  "number": "1.4.6",
  "title": "",
  "body": "  Let be (non-zero) vectors and suppose .  If , then    .  Using the calculation above, mark the statements below that must be true.    Span(x, z) = Span(w, z)    Span(w, z) = Span(x, y)    Span(w, x, y) = Span(y, z)    Span(x, y) = Span(x, y, z)    Span(w, y) = Span(x, z)                  "
},
{
  "id": "worksheet-span",
  "level": "1",
...
},
{
  "id": "exercise-23",
  "level": "2",
  "url": "worksheet-span.html#exercise-23",
...
},
{
  "id": "exercise-24",
  "level": "2",
  "url": "worksheet-span.html#exercise-24",
  "type": "Worksheet Exercise",
  "number": "1.5.2",
  "title": "",
...
},
{
  "id": "exercise-31",
  "level": "2",
  "url": "sec-independence.html#exercise-31",
  "type": "Exercise",
  "number": "1.6.9",
  "title": "",
...
},
{
  ...
  "number": "1.6.2",
  "title": "",
  "body": "  Let be a linear combination of .  Select the best statement.    is never a linearly independent set of vectors.    could be a linearly dependent or linearly dependent set of vectors depending on the vectors chosen.    is a linearly dependent set of vectors unless one of is the zero vector.    is never a linearly dependent set of vectors.    is always a linearly independent set of vectors.    could be a linearly dependent or linearly dependent set of vectors depending on the vector space chosen.    none of the above     , then \" is never a linearly independent set of vectors.\"     "
},
{
  "id": "ex-ww-li3",
  "level": "2",
...
},
{
  ...
  "number": "1.6.5",
  "title": "",
  "body": "  Are the vectors and linearly independent?    choose    linearly dependent    linearly independent    If the vectors are independent, enter zero in every answer blank since zeros are only the values that make the equation below true. If they are dependent, find numbers, not all zero, that make the equation below true. You should be able to explain and justify your answer.                       "
},
{
  "id": "ex-ww-li6",
  "level": "2",
...
},
{
  ...
  "number": "1.6.7",
  "title": "",
  "body": "  Let be a set of vectors.  If , determine whether or not is linearly independent.    Determine whether or not the four vectors listed above are linearly independent or linearly dependent.    If is dependent, enter a non-trivial linear relation below. Otherwise, enter 0's for the coefficients.     .    Linearly_Dependent      "
},
{
  "id": "sec-dimension",
  "level": "1",
...
},
{
  ...
  "number": "1.7.7",
  "title": "",
  "body": "  Let be the vector space of all polynomials of degree 2 or less, and let be the subspace spanned by and .    What is the dimension of the subspace ?    Is a basis for ?      basis for P_2    not a basis for P_2   Be sure you can explain and justify your answer.      Give a basis for the subspace .                       "
},
{
  "id": "ex-ww-basis8",
  "level": "2",
  ...
  "number": "1.7.8",
  "title": "",
  "body": "  Let be the vector space of all polynomials of degree 2 or less, and let be the subspace spanned by and .    What is the dimension of the subspace ?    Is a basis for ?    choose    basis for P_2    not a basis for P_2    Be sure you can explain and justify your answer.      Give a basis for the subspace .                       "
},
{
...
},
{
  "id": "p-750",
  "level": "2",
  "url": "sec-subspace-combine.html#p-750",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "number": "1.8.4",
  "title": "",
  "body": "  Let and be subspaces of the vector space    Is a basis for      Yes    No      What is the dimension of    What is the dimension of                       "
},
{
...
},
{
  "id": "p-815",
  "level": "2",
  "url": "sec-lin-tran-intro.html#p-815",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "number": "2.1.3",
  "title": "",
  "body": "  Let denote the vector space of matrices with real entries. Let be the function defined by for any . Is a linear transformation?  Let and be any two matrices in and let .         .  Does for all ?     Yes, they are equal    No, they are not equal       .     .  Does for all and all ?     Yes, they are equal    No, they are not equal      Is a linear transformation?     f is a linear transformation    f is not a linear transformation                                             "
},
{
  "id": "ex-ww-lt3",
  "level": "2",
  ...
  "number": "2.1.4",
  "title": "",
  "body": "  Let be defined by . Is a linear transformation?     .     .  Does for all ?     Yes, they are equal    No, they are not equal       .      .  Does for all ?     Yes, they are equal    No, they are not equal      Is a linear transformation?     f is a linear transformation    f is not a linear transformation                                             "
},
{
  "id": "ex-ww-lt4",
  "level": "2",
  ...
  "number": "2.1.5",
  "title": "",
  "body": "  Let and be vector spaces and let and .    Suppose is a linear transformation.  Find and write your answer in terms of and .    Suppose is a linear transformation such that and .  Find in terms of and .                  "
},
{
  "id": "ex-ww-lt5",
  "level": "2",
  ...
  "number": "2.1.6",
  "title": "",
  "body": "  Let be a linear transformation that sends the vector into and maps into . Use properties of a linear transformation to calculate the following.                        "
},
{
  "id": "ex-ww-lt6",
  "level": "2",
...
},
{
  "id": "p-991",
  "level": "2",
  "url": "sec-kernel-image.html#p-991",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "rank "
...
},
{
  "id": "p-1006",
  "level": "2",
  "url": "sec-kernel-image.html#p-1006",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "number": "2.2.1",
  "title": "",
  "body": "  Let  Find a basis for the image of (or, equivalently, for the linear transformation ).  A basis for the image of is  ,           "
},
{
  "id": "ex-ww-ki11",
  "level": "2",
...
},
{
  ...
  "number": "2.2.5",
  "title": "",
  "body": "  Suppose is the function defined by    What is ? Enter your answer as a coordinate vector of the form .    If is a linear transformation, find the matrix such that .      Find bases (i.e., minimal spanning sets) for the kernel and image of .                             The linear transformation is (select all that apply):     Bijective (an isomorphism)      Injective (one-to-one)      Surjective (onto)      None of these    "
},
{
  "id": "ex-ww-ki5",
  "level": "2",
...
},
{
  "id": "p-1184",
  "level": "2",
  "url": "sec-isomorphism.html#p-1184",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "ordered basis "
...
},
{
  "id": "p-1189",
  "level": "2",
  "url": "sec-isomorphism.html#p-1189",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "inverse "
},
{
  "id": "exercise-93",
  "level": "2",
  "url": "sec-isomorphism.html#exercise-93",
  "type": "Exercise",
  "number": "2.3.7",
  "title": "",
...
},
{
  "id": "exercise-94",
  "level": "2",
  "url": "sec-isomorphism.html#exercise-94",
  "type": "Exercise",
  "number": "2.3.8",
  "title": "",
...
},
{
  "id": "exercise-95",
  "level": "2",
  "url": "sec-isomorphism.html#exercise-95",
  "type": "Exercise",
  "number": "2.3.9",
  "title": "",
...
},
{
  "id": "p-1254",
  "level": "2",
  "url": "worksheet-transformations.html#p-1254",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "kernel "
},
{
  "id": "p-1255",
  "level": "2",
  "url": "worksheet-transformations.html#p-1255",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "image "
},
{
  "id": "exercise-100",
  "level": "2",
  "url": "worksheet-transformations.html#exercise-100",
  "type": "Worksheet Exercise",
  "number": "2.4.1",
  "title": "",
...
},
{
  "id": "exercise-101",
  "level": "2",
  "url": "worksheet-transformations.html#exercise-101",
  "type": "Worksheet Exercise",
  "number": "2.4.2",
  "title": "",
...
},
{
  "id": "exercise-102",
  "level": "2",
  "url": "worksheet-transformations.html#exercise-102",
  "type": "Worksheet Exercise",
  "number": "2.4.3",
  "title": "",
...
},
{
  "id": "p-1271",
  "level": "2",
  "url": "worksheet-transformations.html#p-1271",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "column space "
...
},
{
  "id": "exercise-107",
  "level": "2",
  "url": "worksheet-recurrence.html#exercise-107",
  "type": "Worksheet Exercise",
  "number": "2.5.1",
  "title": "",
...
},
{
  "id": "exercise-108",
  "level": "2",
  "url": "worksheet-recurrence.html#exercise-108",
  "type": "Worksheet Exercise",
  "number": "2.5.2",
  "title": "",
  "body": " Find a basis for the space of sequences satisfying the recurrence . Then find a formula for the sequence satisfying the initial conditions .  "
},
{
  "id": "exercise-109",
  "level": "2",
  "url": "worksheet-recurrence.html#exercise-109",
  "type": "Worksheet Exercise",
  "number": "2.5.3",
  "title": "",
  "body": " Find a basis for the space of sequences satisfying the recurrence . Then find a formula for the sequence satisfying the initial conditions .  "
...
},
{
  "id": "p-1374",
  "level": "2",
  "url": "sec-orthogonal-sets.html#p-1374",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "unit vector "
...
},
{
  ...
  "number": "3.2.5",
  "title": "",
  "body": "  Confirm that the set is a basis for , and use the to find an orthonormal basis.    First, note that we can actually jump right into the Gram-Schmidt procedure. If the set is not a basis, then it won't be independent, and when we attempt to construct the third vector in our orthonormal basis, its projection on the the subspace spanned by the first two will be the same as the original vector, and we'll get zero when we subtract the two.  We let , and set . Then we have .   You'll notice that we're using rather than in the calculation of . This lets us avoid fractions (momentarily), and doesn't affect the answer, since for any nonzero scalar , .   Next, we compute . .  We got it done! But doing this sort of thing by hand makes it possible that we made a calculation error somewhere. To check our work, we can turn to the computer.    "
},
{
  "id": "ex-ww-gs1",
  "level": "2",
...
},
{
  "id": "p-1548",
  "level": "2",
  "url": "worksheet-dual-basis.html#p-1548",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-1562",
  "level": "2",
  "url": "worksheet-dual-basis.html#p-1562",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "dual basis "
},
{
  "id": "exercise-140",
  "level": "2",
  "url": "worksheet-dual-basis.html#exercise-140",
  "type": "Worksheet Exercise",
  "number": "3.4.1",
  "title": "",
...
},
{
  "id": "exercise-141",
  "level": "2",
  "url": "worksheet-dual-basis.html#exercise-141",
  "type": "Worksheet Exercise",
  "number": "3.4.2",
  "title": "",
...
},
{
  "id": "exercise-142",
  "level": "2",
  "url": "worksheet-dual-basis.html#exercise-142",
  "type": "Worksheet Exercise",
  "number": "3.4.3",
  "title": "",
...
},
{
  "id": "p-1579",
  "level": "2",
  "url": "worksheet-dual-basis.html#p-1579",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "annihilator "
...
},
{
  "id": "p-1591",
  "level": "2",
  "url": "worksheet-least-squares.html#p-1591",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "overdetermined "
},
{
  "id": "p-1605",
  "level": "2",
  "url": "worksheet-least-squares.html#p-1605",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "exercise-145",
  "level": "2",
  "url": "worksheet-least-squares.html#exercise-145",
  "type": "Worksheet Exercise",
  "number": "3.5.1",
  "title": "",
...
},
{
  "id": "exercise-146",
  "level": "2",
  "url": "worksheet-least-squares.html#exercise-146",
  "type": "Worksheet Exercise",
  "number": "3.5.2",
  "title": "",
...
},
{
  "id": "exercise-147",
  "level": "2",
  "url": "worksheet-least-squares.html#exercise-147",
  "type": "Worksheet Exercise",
  "number": "3.5.3",
  "title": "",
...
},
{
  "id": "p-1613",
  "level": "2",
  "url": "worksheet-least-squares.html#p-1613",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "residuals "
...
},
{
  ...
  "number": "4.1.3",
  "title": "",
  "body": " Eigenvalues and eigenvectors can just as easily be defined for a general linear operator . In this context, and eigenvector is sometimes referred to as a characteristic vector (or characteristic direction) for , since the property simply states that the transformed vector is parallel to the original vector . Some linear algebra textbooks that focus more on general linear transformations frame this topic in the context of invariant subspaces for a linear operator.  A subspace is invariant with respect to if for all . Note that if is an eigenvector of , then is an invariant subspace. To see this, note that if and , then .  "
},
{
  "id": "ex-match-eigen1",
  "level": "2",
...
},
{
  "id": "p-1636",
  "level": "2",
  "url": "sec-eigen-basics.html#p-1636",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-1638",
  "level": "2",
  "url": "sec-eigen-basics.html#p-1638",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-1648",
  "level": "2",
  "url": "sec-eigen-basics.html#p-1648",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "multiplicity "
...
},
{
  "id": "p-1665",
  "level": "2",
  "url": "subsec-ortho-diag.html#p-1665",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "symmetric "
},
{
  "id": "exercise-154",
  "level": "2",
  "url": "subsec-ortho-diag.html#exercise-154",
  "type": "Exercise",
  "number": "4.2.1",
  "title": "",
...
},
{
  "id": "exercise-155",
  "level": "2",
  "url": "subsec-ortho-diag.html#exercise-155",
  "type": "Exercise",
  "number": "4.2.7",
  "title": "",
...
},
{
  "id": "exercise-156",
  "level": "2",
  "url": "sec-complex.html#exercise-156",
  "type": "Exercise",
  "number": "4.4.2",
  "title": "",
...
},
{
  "id": "exercise-158",
  "level": "2",
  "url": "sec-complex.html#exercise-158",
  "type": "Exercise",
  "number": "4.4.8",
  "title": "",
...
},
{
  "id": "exercise-159",
  "level": "2",
  "url": "sec-complex.html#exercise-159",
  "type": "Exercise",
  "number": "4.4.12",
  "title": "",
...
},
{
  "id": "p-1790",
  "level": "2",
  "url": "worksheet-dynamical.html#p-1790",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "exercise-161",
  "level": "2",
  "url": "worksheet-dynamical.html#exercise-161",
  "type": "Worksheet Exercise",
  "number": "4.5.1",
  "title": "",
...
},
{
  "id": "exercise-162",
  "level": "2",
  "url": "worksheet-dynamical.html#exercise-162",
  "type": "Worksheet Exercise",
  "number": "4.5.2",
  "title": "",
...
},
{
  "id": "exercise-163",
  "level": "2",
  "url": "worksheet-dynamical.html#exercise-163",
  "type": "Worksheet Exercise",
  "number": "4.5.3",
  "title": "",
...
},
{
  "id": "exercise-164",
  "level": "2",
  "url": "worksheet-dynamical.html#exercise-164",
  "type": "Worksheet Exercise",
  "number": "4.5.4",
  "title": "",
...
},
{
  "id": "exercise-165",
  "level": "2",
  "url": "worksheet-dynamical.html#exercise-165",
  "type": "Worksheet Exercise",
  "number": "4.5.5",
  "title": "",
...
},
{
  "id": "exercise-166",
  "level": "2",
  "url": "worksheet-dynamical.html#exercise-166",
  "type": "Worksheet Exercise",
  "number": "4.5.6",
  "title": "",
...
},
{
  "id": "exercise-167",
  "level": "2",
  "url": "worksheet-dynamical.html#exercise-167",
  "type": "Worksheet Exercise",
  "number": "4.5.7",
  "title": "",
...
},
{
  "id": "p-1845",
  "level": "2",
  "url": "section-matrix-factor.html#p-1845",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-1851",
  "level": "2",
  "url": "section-matrix-factor.html#p-1851",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "remark-18",
  "level": "2",
  "url": "section-matrix-factor.html#remark-18",
  "type": "Remark",
  "number": "4.6.3",
  "title": "",
...
},
{
  "id": "p-1876",
  "level": "2",
  "url": "section-matrix-factor.html#p-1876",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "exercise-172",
  "level": "2",
  "url": "sec-matrix-of-transformation.html#exercise-172",
  "type": "Exercise",
  "number": "5.1.3",
  "title": "",
...
},
{
  "id": "example-22",
  "level": "2",
  "url": "sec-matrix-of-transformation.html#example-22",
  "type": "Example",
  "number": "5.1.4",
...
},
{
  "id": "exercise-173",
  "level": "2",
  "url": "sec-matrix-of-transformation.html#exercise-173",
  "type": "Exercise",
  "number": "5.1.7",
  "title": "",
...
},
{
  "id": "exercise-174",
  "level": "2",
  "url": "sec-matrix-operator.html#exercise-174",
  "type": "Exercise",
  "number": "5.2.4",
  "title": "",
...
},
{
  "id": "exercise-175",
  "level": "2",
  "url": "sec-direct-sum.html#exercise-175",
  "type": "Exercise",
  "number": "5.3.2",
  "title": "",
...
},
{
  "id": "p-2018",
  "level": "2",
  "url": "sec-direct-sum.html#p-2018",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "direct sum "
},
{
  "id": "p-2019",
  "level": "2",
  "url": "sec-direct-sum.html#p-2019",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "complement "
...
},
{
  "id": "p-2036",
  "level": "2",
  "url": "worksheet-gen-eigen.html#p-2036",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-2116",
  "level": "2",
  "url": "appendix-complex-review.html#p-2116",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-2119",
  "level": "2",
  "url": "appendix-complex-review.html#p-2119",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "polar form "
...
},
{
  "id": "p-2123",
  "level": "2",
  "url": "section-jupyter.html#p-2123",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-2125",
  "level": "2",
  "url": "section-jupyter.html#p-2125",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
